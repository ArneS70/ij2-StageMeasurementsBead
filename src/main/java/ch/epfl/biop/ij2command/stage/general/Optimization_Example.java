...
import ch.epfl.biop.ij2command.USAF.USAF_BatchAnalyser;
 ...
 * </ul>
 */
@Plugin(type = Command.class, menuPath = "Plugins>BIOP>Optimize")
public class Optimization_Example implements Command {
	/**
	...
	public static void main(final String... args) throws Exception {
		...
		ij.ui().showUI();
		ij.command().run(Optimization_Example.class, true);
	}
}
